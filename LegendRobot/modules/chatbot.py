...
def check_message(context: CallbackContext, message):
    ...
    if message.text.lower() == "LegendRobot":
        return True
    if reply_msg:
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows LegendRobot to talk and provides a more interactive group chat experience.
